"""
Bublee Uncertainty Detector — Identifies knowledge gaps and alerts admins.

Detects when Bublee is uncertain about her answers and logs gaps
...
log = logging.getLogger("bublee.uncertainty")
...
class UncertaintyDetector:
    ...
    async def alert_admin(
        ...
        alert_text = (
            f"Hola, soy Bublee de {instance_id}. "
