"""
Bublee V7.0 — Orquestador
============================
Conecta router, memoria, agentes y postprocessor.
bublee.py llama a orchestrator.process() en lugar de generator.generate().
...
class BubleeOrchestrator:
    """
    Orquestador central de Bublee V7.
    Se instancia una vez al arranque de BubleeUltra.
    """
    ...
    async def process(
        ...
        if not agent:
            ...
            return None  # señal para que bublee.py use el generator clásico
    ...
    async def _notify_escalation(
        ...
        try:
            ...
            # El envío real lo hace bublee.py con _send_message
