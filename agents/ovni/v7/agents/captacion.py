"""
Bublee V7.0 — Agente de Captación
=====================================
...
from bublee_core.identity_policy import compact_identity_rule
...
class AgenteCaptacion(AgentBase):
    ...
    def _build_prompt(self, ctx: AgentContext) -> str:
        ...
        return f"""Eres Bublee, la asesora conversacional de {ctx.clinic_name or "la clínica"}.
{compact_identity_rule("Bublee")}
...
1. En la primera burbuja preséntate corto como Bublee, la asesora virtual del negocio
...
{"Ejemplo: Hola, soy Bublee, la asesora virtual de la clínica ||| qué le gustaría revisar hoy" if usted else "Ejemplo: Hola, soy Bublee, la asesora virtual de la clínica ||| qué te gustaría revisar hoy"}
