#!/usr/bin/env python3
"""
bublee_router.py — Webhook handlers and command routing.
Extracted from bublee.py for Phase 3 split.
"""
...
from bublee_config import Config, DEMO_CMD_ALIASES, DEMO_COMMANDS, DEMO_HELP_FULL

log = logging.getLogger("bublee.router")
