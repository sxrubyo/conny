# Bublee Human Patient Dialogue Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Hacer que Bublee responda a pacientes desde el modelo, con identidad y criterio conversacional, sin saludos ni fallbacks prefabricados.
...
Run: `pytest /home/ubuntu/bublee-instances/clinica-de-las-americas/tests/test_patient_conversation_humanity.py -q`
...
Run: `python3 -m py_compile /home/ubuntu/bublee-instances/clinica-de-las-americas/bublee.py`
Expected: exit 0

- [ ] **Step 3: Inspect live persisted state**

Run: `sqlite3 /home/ubuntu/bublee-instances/clinica-de-las-americas/bublee.db "SELECT key, value FROM core_memory WHERE key IN ('v8_owner_style_control','v8_prompt_evolutions');"`
