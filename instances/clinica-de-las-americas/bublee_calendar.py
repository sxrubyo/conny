"""bublee_calendar.py — Google Calendar: check availability + book appointments."""
...
log = logging.getLogger("bublee.calendar")

VAULT_DIR = Path("integrations/vault")


class BubleeCalendar:
    ...
    async def get_availability_summary(self, days_ahead: int = 3) -> str:
        """Get human-readable availability summary for Bublee to use."""
