"""
knowledge_base.py — Base de conocimiento de la clinica para Bublee
...
y que Bublee consulte siempre antes de responder.

Flujo:
  1. Admin termina setup y Bublee le pide el documento maestro
...
log = logging.getLogger("bublee.kb")
...
class KnowledgeBase:
    ...
    Se inicializa con la conexion DB de bublee.
    """
