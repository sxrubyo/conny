"""
search.py — Motor de busqueda para Bublee v2
...
Incluye:
  ...
  - SearchEngine compatible con bublee.py
"""
...
# ─── Clase compatible con bublee.py ─────────────────────────────────────────

class SearchEngine:
    """
    Interfaz compatible con WebSearchEngine en bublee.py.
