...
| 11639–22015 | BubleeUltra (orchestrator god-class) |
| 20327–22015 | FastAPI routes (inside BubleeUltra? No — top-level after class) |
...
|------|-------|
| bublee.py | 28,972 |
| bublee_cli.py | 11,716 |
| bublee-omni.py | 3,828 |
| smart_handoff.py | 1,150 |
| bublee_brain_v10.py | 804 |
| bublee_admin.py | 772 |
| bublee_domino.py | 696 |
| bublee_bridge.py | 656 |
| bublee_i18n.py | 618 |
| bublee-chat.py | 578 |
| bublee_send_guard.py | 550 |
| bublee_tui.py | 502 |
| bublee_nuke_robot_phrases.py | 493 |
| bublee_pitch_upgrade.py | 471 |
| bublee_generator.py | 446 |
| bublee_cli_bb.py | 437 |
| bublee_production.py | 353 |
| bublee_audio.py | 349 |
| bublee_smart_features.py | 333 |
| knowledge_base.py | 330 |
| bublee_session.py | 320 |
| bublee_router.py | 307 |
| bublee_sync_fix.py | 306 |
| bublee_app.py | 304 |
| bublee_memory_engine.py | 292 |
| bublee_pairing.py | 253 |
| bublee_patch.py | 291 |
| All others | <250 each |
| **TOTAL** | **59,992** |
...
- **BubleeUltra** is a 10,377-line god-class (36% of the file)
