#!/usr/bin/env python3
"""
Chat interactivo continuo con Conny via HTTP.
...
CONNY_URL = "http://localhost:8001"
MASTER_KEY = "conny_master_2026_santiago"

def chat_loop(user_id: str):
    """Loop de conversación interactiva con Conny."""
    
    print("""
╔══════════════════════════════════════════════════════════╗
║         💬 CHAT CONTINUO CON CONNY v8.0               ║
...
def send_message(session, text: str, user_id: str) -> str:
    """Envía mensaje a Conny y retorna respuesta."""
    try:
        resp = session.post(
            f"{CONNY_URL}/test",
...
if __name__ == "__main__":
    ...
    print(f"🔗 Conectando a Conny en {CONNY_URL}...")
    chat_loop(user_id)