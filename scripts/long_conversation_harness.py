#!/usr/bin/env python3
"""Harness HTTP agnóstico para conversaciones largas con Bublee.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Harness HTTP agnóstico para conversaciones largas con Bublee"
    )
    ...
    parser.add_argument(
        "--master-key",
        default=os.getenv("BUBLEE_MASTER_KEY", ""),
