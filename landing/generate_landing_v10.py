...
<head>
    ...
    <style>
        /* DESIGN SYSTEM - Professional White/Light Editorial Aesthetic */
        :root {
            --bg-void: #FFFFFF; 
            --bg-surface: rgba(255, 255, 255, 0.6); 
            --bg-elevated: rgba(255, 255, 255, 0.8);
            --bg-code: rgba(241, 245, 249, 0.8);
            ...
            --text-primary: #020617; /* Very dark slate, almost black */
            --text-secondary: #475569; /* Medium slate */
            --text-muted: #94A3B8;
            
            --gradient-hero: linear-gradient(135deg, #020617 0%, #475569 100%);
        ...
        * {
        ...
        .logo-mark {
            ...
            object-fit: contain;
            margin-right: 12px;
            /* Remove invert to keep it black/dark on light background */
        }
        ...
        footer {
            ...
            background: rgba(255,255,255,0.9); /* Solid base for footer */
...
<body>
    ...
    <!-- Static White Background Image -->
    <div class="bg-image"></div>
    <!-- Removed overlay to keep image pure -->
