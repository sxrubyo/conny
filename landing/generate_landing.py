...
<head>
    ...
    <style>
        ...
        /* DARK THEME (Auto-switch based on OS preference) */
        ...
        * {
        ...
        nav {
            ...
            background: rgba(var(--bg-void), 0.8);
        ...
        .mockup-wrapper {
            ...
            opacity: 0;
            animation: slideInRight 0.6s 0.3s forwards ease-out;
        }
        
        .wa-mockup {
            background: var(--wa-bg);
            border-radius: 28px;
            border: 10px solid var(--wa-border);
            overflow: hidden;
        ...
        @media (max-width: 992px) {
            ...
            .mockup-wrapper { margin-top: 60px; transform: translateY(50px); animation-name: slideUpFade; }
        ...
        <div class="hero-grid">
            ...
            <div class="mockup-wrapper">
                ...
                <div class="mockup-badge">
                    ...
                    Powered by Bublee &middot; Responding in 0.8s
                </div>
            </div>
        </div>
    </header>
