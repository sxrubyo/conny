"""bublee_weekly_report.py — Weekly brain report to admin."""
...
log = logging.getLogger("bublee.weekly_report")


async def generate_weekly_report(instance_id: str, db_path: str = "bublee.db") -> str:
...
async def send_weekly_report(instance_id: str, admin_jid: str, send_fn, db_path: str = "bublee.db"):
